<template>
  <div>
    <section class="bg-white dark:bg-pictoblue2">
      <div
      ...
      >
        <form class="w-full max-w-md">
          ...
          >
            ...
            <h2 class="mx-3 text-gray-400" v-if="profileimagename">
              {{ profileimagename }}
            </h2>
            <h2 v-else class="mx-3 text-gray-400">Upload your image</h2>
          ...
          <div class="mt-6">
            <button
              ...
              class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-pictored bg-opacity-75 rounded-lg focus:ring focus:ring-blue-300 focus:ring-opacity-50"
            >
              Sign Up
            </button>
...
const uploadProfile = async (event) => {
  ...
  profileurl.value = res.data.imagename;
};
</script>
