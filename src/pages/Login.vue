      ...
      >
        <form class="w-full max-w-md">
          ...
          <div class="mt-6">
            ...
            <a
              href="#"
              class="flex items-center justify-center px-6 py-3 mt-4 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-pictored dark:hover:bg-opacity-30"
            >
